...
const LOCAL_CATEGORY_EXEMPT_SOURCES = ['barbadostoday.bb', 'ewnews.com', 'iwnsvg.com', 'total-montenegro-news.com'];
...
const ALLOWLIST_BY_COUNTRY = {
  ...
  CD: ['radiookapi.net', 'actualite.cd', 'congoplanet.com'],
  ...
  ET: ['ena.et', 'thereporterethiopia.com', 'addisstandard.com', 'ethiopianreporter.com', 'capitalethiopia.com'],
  ...
  ID: ['thejakartapost.com', 'tempo.co', 'kompas.com', 'antaranews.com', 'jakartaglobe.id', 'thebalitimes.com'],
  IN: ['timesofindia.indiatimes.com', 'hindustantimes.com', 'ndtv.com', 'thehindu.com', 'indianexpress.com', 'news18.com', 'moneycontrol.com'],
  IR: ['en.irna.ir', 'mehrnews.com', 'presstv.ir', 'tehrantimes.com', 'irna.ir', 'khabaronline.ir'],
  ...
  ZA: ['iol.co.za', 'timeslive.co.za', 'news24.com', 'sabcnews.com', 'ewn.co.za', 'citizen.co.za', 'sowetanlive.co.za', 'dailymaverick.co.za'],
  ...
  SG: ['straitstimes.com', 'todayonline.com', 'businesstimes.com.sg', 'theindependent.sg', 'tnp.sg'],
  ...
  IE: ['thejournal.ie', 'independent.ie'],
  IL: ['jpost.com'],
  RO: ['biziday.ro'],
  FI: ['yle.fi'],
  BZ: ['amandala.com.bz'],
  CY: ['in-cyprus.philenews.com', 'sigmalive.com'],
  ...
  BB: ['barbadostoday.bb'],
  BS: ['ewnews.com', 'bahamaspress.com'],
  VC: ['iwnsvg.com'],
